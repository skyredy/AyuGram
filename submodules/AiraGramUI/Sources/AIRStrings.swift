...
private let airStringsRu: [String: String] = [
    ...
    "ProfileExactViewsInfo": "Число просмотров под постом показывается полностью, без округления.",
    ...
    "ProfileSecondsInfo": "Добавляет секунды к времени рядом с сообщениями и постами.",
...
private let airStringsEn: [String: String] = [
    ...
    "ProfileExactViewsInfo": "The view count under a post is shown in full, not rounded.",
    ...
    "ProfileSecondsInfo": "Adds seconds to the time shown next to messages and posts.",
